...
<body>
    <div class="w-50 mx-auto mt-5">
        <h2 class="text-center mb-2">Hi {{ $name }}, we're ready to create a new password for you!</h2>
        ...
        <div class="my_input mx-auto">
            <form action="{{ route('confirm_loginforget_newpass') }}" method="POST" class="form-control border-2 p-3">
                @csrf
                @method('PUT')
