...
<body>
    <div class="w-50 mx-auto mt-5">
        <h2 class="text-center mb-2">One more step to complete your registration</h2>
        ...
        <div class="my_input mx-auto">
            <form action="{{ route('confirm_register') }}" method="POST" class="form-control border-2 p-3">
                @csrf
